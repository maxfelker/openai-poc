...
func main() {
	...
	request := ChatCompletionRequest{
		...
		Messages: []Message{
			{
				Role:    "system",
				Content: "Using the information provided, create a table in a chat response format. The table should list command keywords related to a job description for a tech leadership role and their respective descriptions. The commands are '/growth', '/accelerate', '/innovation', '/collaboration', '/humans', and '/foster'. Each command should have a brief description such as 'How to attract, hire, and grow diverse team members' for '/growth'. Ensure the table is clear, concise, and formatted for easy readability in a chat environment",
			},
			{
				Role:    "user",
				Content: "/growth",
